...
from archive.multiclass.singleclassifier import ClassifierModule
...
def main(cfg: DictConfig):
    ...
    train_prev_prediction = None
    val_prev_prediction = None
    ...
    for i in range(3):
        ...
        mlp_model = ClassifierModule(i, train_prev_prediction, val_prev_prediction, test_prev_prediction)
        ...
        train_prev_prediction = mlp_model.train_predictions 
        val_prev_prediction = mlp_model.val_predictions
