from datasets.dataset2 import SourceCountingDataLoader
...
def main(cfg: DictConfig):
    ...
    for data_type in data_types:
        data_loader = SourceCountingDataLoader(getattr(cfg, data_type), window_size=window_size, stride= stride, batch_size=batch_size, num_workers=num_workers)
    ...
    trainer.fit(rnn_model, data_loaders["train"], data_loaders["validate"])
